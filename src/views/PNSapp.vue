            ...
            <v-stepper-items>
              ...
              <v-stepper-content step="2">
                <v-card min-height="500">
                  Sequence Order:
                  <span v-for="i in todos" :key="todos[i]"> {{ i }}+ </span>
                  <pre></pre>
...
export default {
  ...
  computed: {
    ...
    filteredRules() {
      if (this.alphabets && !this.numbers && !this.symbols) {
        return [this.rules[0]];
      } else if (!this.alphabets && this.numbers && !this.symbols) {
        return [this.rules[1]];
      } else if (!this.alphabets && !this.numbers && this.symbols) {
        return [this.rules[2]];
      } else if (this.alphabets && this.numbers && !this.symbols) {
    ...
    filteredRules2() {
      if (this.alphabets2 && !this.numbers2 && !this.symbols2) {
        return [this.rules2[0]];
      } else if (!this.alphabets2 && this.numbers2 && !this.symbols2) {
        return [this.rules2[1]];
      } else if (!this.alphabets2 && !this.numbers2 && this.symbols2) {
        return [this.rules2[2]];
      } else if (this.alphabets2 && this.numbers2 && !this.symbols2) {
        return [
          (v) =>
            /^[a-zA-Z0-9]+$/.test(v) ||
    ...
    filteredRules3() {
      if (this.alphabets3 && !this.numbers3 && !this.symbols3) {
        return [this.rules3[0]];
      } else if (!this.alphabets3 && this.numbers3 && !this.symbols3) {
        return [this.rules3[1]];
      } else if (!this.alphabets3 && !this.numbers3 && this.symbols3) {
        return [this.rules3[2]];
      } else if (this.alphabets3 && this.numbers3 && !this.symbols3) {
        return [
          (v) =>
            /^[a-zA-Z0-9]+$/.test(v) ||
      ...
      } else if (this.alphabets3 && this.numbers3 && this.alphabets3) {
        return [
          (v) =>
            /^[a-zA-Z0-9\W]+$/.test(v) ||
            "Only alphabets, numbers, and symbols are allowed",
  ...
  methods: {
    ...
    radioselectedvalue1(e){
      
      // this.radioarray.push(e)
      // this.PolyData.Textlength=this.radioarray;
    },
    radioselectedvalue2(e){
      // this.radioarray.push(e)
      // this.PolyData.Textlength=this.radioarray;
    },
    radioselectedvalue3(e){
    ...
    finalPrefix() {
      ...
      if (this.disableCheckbox === true) {
        ...
        // this.pretext=this.pretext.push(this.pre1)
        this.prefix = abc;
      }
      if (this.enabled === true) {
        abc = `${"_".repeat(this.selectedRadio)}`;
        // this.pretext = this.listArr;
        this.pretext=this.listArr.map(str => str.substring(0, this.selectedRadio))
    ...
    finalSuffix() {
      ...
      if (this.enabled2 === true) {
        abc = `${"_".repeat(this.selectedRadio2)}`;
        // this.sufftext = this.listArr2;
        this.sufftext=this.listArr2.map(str => str.substring(0, this.selectedRadio2))
    ...
    finalText1() {
      ...
      if (this.enabled3 === true) {
        abc = `${"_".repeat(this.selectedRadio8)}`;
        // this.textext1 = this.listArr3;
        this.textext1=this.listArr3.map(str => str.substring(0, this.selectedRadio8));
    ...
    finalText2() {
      ...
      if (this.enabled4 === true) {
        abc = `${"_".repeat(this.selectedRadio9)}`;
        // this.textext2 = this.listArr4;
        this.textext2=this.listArr4.map(str => str.substring(0, this.selectedRadio9))
    ...
    finalText3() {
      ...
      if (this.enabled5 === true) {
        abc = `${"_".repeat(this.selectedRadio10)}`;
        // this.textext3 = this.listArr5;
        this.textext3=this.listArr5.map(str => str.substring(0, this.selectedRadio10))
    ...
    finalText4() {
      ...
      if (this.disableCheckbox6 === true) {
        ...
        if (this.enabled6 === true) {
          abc = `${"_".repeat(this.selectedRadio11)}`;
          // this.textext4 = this.listArr6;
          this.textext4=this.listArr6.map(str => str.substring(0, this.selectedRadio11))
    ...
    finalText5() {
      ...
      if (this.disableCheckbox7 === true) {
        ...
        if (this.enabled7 === true) {
          abc = `${"_".repeat(this.selectedRadio12)}`;
          // this.textext5 = this.listArr7;
          this.textext5=this.listArr7.map(str => str.substring(0, this.selectedRadio12))
...
// Check if Prefix, Suffix and Sequence are present in the array

// Remove Prefix, Suffix and Sequence
const filteredArr = arr.filter(item => !['Prefix', 'Suffix', 'Sequence'].includes(item));

// Add Prefix at the beginning
filteredArr.unshift('Prefix');

// Add Suffix and Sequence at the end
